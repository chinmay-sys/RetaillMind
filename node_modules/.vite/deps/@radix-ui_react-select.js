...
} from "./chunk-FC7KCISD.js";
import {
  Combination_default,
  FocusScope,
  hideOthers,
  useFocusGuards
} from "./chunk-U6F2P4XI.js";
import {
  createCollection,
  useDirection
} from "./chunk-Y65RF6GB.js";
import {
  Anchor,
  Arrow,
  Content,
  ...
  Root2,
  createPopperScope
} from "./chunk-54UX6ONJ.js";
import "./chunk-CFD3CMCP.js";
import {
  Presence,
  useId
} from "./chunk-WXIKUDXT.js";
import {
  composeEventHandlers,
  useControllableState
} from "./chunk-BX4MSSWT.js";
import {
  useCallbackRef
} from "./chunk-SADVYNDT.js";
import {
  useLayoutEffect2
} from "./chunk-4ASLQAYX.js";
import {
  createContextScope
} from "./chunk-BKJF3HLC.js";
import {
  Primitive
} from "./chunk-6GM7AQCQ.js";
import {
  createSlot,
  useComposedRefs
} from "./chunk-P6MUFA4S.js";
import {
  require_react_dom
} from "./chunk-CMSQVTYY.js";
import {
  require_jsx_runtime
...
__name2(usePrevious, "usePrevious");
...
function SelectProvider(props) {
  ...
  React2.useEffect(() => {
    ...
    if (associatedForm instanceof HTMLFormElement) {
      const reset = __name3(() => setValue(initialValueRef.current), "reset");
...
__name3(SelectProvider, "SelectProvider");
var Select = __name3((props) => {
...
var SelectTrigger = React2.forwardRef(
  __name3(function SelectTrigger2(props, forwardedRef) {
    ...
    const handleOpen = __name3((pointerEvent) => {
      if (!isDisabled) {
...
var SelectValue = React2.forwardRef(
  __name3(function SelectValue2(props, forwardedRef) {
    ...
    return (0, import_jsx_runtime.jsx)(
      Primitive.span,
      {
        ...
        children: (0, import_jsx_runtime.jsx)(React2.Fragment, { children: showPlaceholder ? placeholder : children }, showPlaceholder ? "placeholder" : "value")
      }
    );
  }, "SelectValue")
);
var SelectIcon = React2.forwardRef(
  __name3(function SelectIcon2(props, forwardedRef) {
...
var SelectPortal = __name3((props) => {
...
var SelectContent = React2.forwardRef(
  __name3(function SelectContent2(props, forwardedRef) {
...
var SelectContentFragment = React2.forwardRef(__name3(function SelectContentFragment2(props, forwardedRef) {
...
var SelectContentImpl = React2.forwardRef(
  ...
  __name3(function SelectContentImpl2(props, forwardedRef) {
    ...
    React2.useEffect(() => {
      if (content) {
        ...
        const handlePointerMove = __name3((event) => {
          var _a, _b;
          pointerMoveDelta = {
        ...
        const handlePointerUp = __name3((event) => {
    ...
    React2.useEffect(() => {
      const close = __name3(() => onOpenChange(false), "close");
...
var SelectItemAlignedPosition = React2.forwardRef(__name3(function SelectItemAlignedPosition2(props, forwardedRef) {
...
var SelectPopperPosition = React2.forwardRef(__name3(function SelectPopperPosition2(props, forwardedRef) {
  const {
    __scopeSelect,
    align = "start",
...
var SelectViewport = React2.forwardRef(
  __name3(function SelectViewport2(props, forwardedRef) {
...
var SelectGroup = React2.forwardRef(
  __name3(function SelectGroup2(props, forwardedRef) {
...
var SelectLabel = React2.forwardRef(
  __name3(function SelectLabel2(props, forwardedRef) {
...
var SelectItem = React2.forwardRef(
  __name3(function SelectItem2(props, forwardedRef) {
    const {
      __scopeSelect,
      value,
      disabled = false,
...
var SelectItemText = React2.forwardRef(
  __name3(function SelectItemText2(props, forwardedRef) {
...
var SelectItemIndicator = React2.forwardRef(
  // blank line to reduce diff noise
  __name3(function SelectItemIndicator2(props, forwardedRef) {
...
var SelectScrollUpButton = React2.forwardRef(__name3(function SelectScrollUpButton2(props, forwardedRef) {
  ...
  useLayoutEffect2(() => {
    if (contentContext.viewport && contentContext.isPositioned) {
      ...
      __name3(handleScroll2, "handleScroll");
...
var SelectScrollDownButton = React2.forwardRef(__name3(function SelectScrollDownButton2(props, forwardedRef) {
...
var SelectScrollButtonImpl = React2.forwardRef(__name3(function SelectScrollButtonImpl2(props, forwardedRef) {
...
var SelectSeparator = React2.forwardRef(
  // blank line to reduce diff noise
  __name3(function SelectSeparator2(props, forwardedRef) {
...
var SelectArrow = React2.forwardRef(
  __name3(function SelectArrow2(props, forwardedRef) {
...
var SelectBubbleInput = React2.forwardRef(
  // blank line to reduce diff noise
  __name3(function SelectBubbleInput2({ __scopeSelect, ...props }, forwardedRef) {
...
__name3(shouldShowPlaceholder, "shouldShowPlaceholder");
function useTypeaheadSearch(onSearchChange) {
  ...
  const handleTypeaheadSearch = React2.useCallback(
    (key) => {
      ...
      __name3((function updateSearch(value) {
...
__name3(useTypeaheadSearch, "useTypeaheadSearch");
...
__name3(findNextItem, "findNextItem");
function wrapArray(array, startIndex) {
  return array.map((_, index) => array[(startIndex + index) % array.length]);
}
__name3(wrapArray, "wrapArray");
export {
