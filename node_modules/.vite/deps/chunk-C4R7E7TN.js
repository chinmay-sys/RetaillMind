...
function usePresence(present) {
  ...
  useLayoutEffect2(() => {
    if (node) {
      ...
      const handleAnimationEnd = __name2((event) => {
      ...
      const handleAnimationStart = __name2((event) => {
...
__name2(useStableComposedRefs, "useStableComposedRefs");
...
//# sourceMappingURL=chunk-C4R7E7TN.js.map
